...
import { Home, MapPin, RefreshCw, ArrowLeft, Layers } from 'lucide-react';
...
const InsuranceHomeReady = () => {
  ...
  const runAnalysis = async () => {
    ...
    toast({
      ...
      description: "Running built home risk analysis..."
    });
    ...
    try {
      ...
      toast({
        ...
        description: "Built home risk assessment generated successfully!"
      });
    } catch (error: any) {
  ...
  const handleRestart = () => {
    ...
    setAnalysisConfig({ insuranceType: 'home-ready' });
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-foreground">Built Home Risk Analysis</h1>
                  <p className="text-xs text-muted-foreground">Assess existing property insurance risks</p>
                </div>
              </div>
            </div>
...
export default InsuranceHomeReady;
