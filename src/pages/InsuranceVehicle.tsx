...
import { Car, MapPin, RefreshCw, ArrowLeft } from 'lucide-react';
...
const InsuranceVehicle = () => {
  ...
  const runAnalysis = async () => {
    ...
    toast({
      ...
      description: "Running comprehensive vehicle insurance risk analysis with real geospatial data..."
    });
  ...
  const handleDownload = async (format: 'geotiff' | 'png' | 'pdf') => {
    if (format === 'pdf') {
      ...
      try {
        ...
        a.href = url;
        a.download = `Vehicle_Insurance_Risk_Report_${Date.now()}.pdf`;
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-foreground">Vehicle Insurance Risk Analysis</h1>
                  <p className="text-xs text-muted-foreground">Road and environmental risk assessment for vehicles</p>
                </div>
              </div>
            </div>
